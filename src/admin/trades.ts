...
var TradesListController = ($scope : TradesScope, $log : ng.ILogService, subscriberFactory : Shared.SubscriberFactory, uiGridConstants: any) => {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            {field:'side', displayName:'Side', cellClass: (grid, row, col, rowRenderIndex, colRenderIndex) => {
            ...
            {width: 30, field:'liquidity', displayName:'Liquidity'},
            {width: 60, field:'value', displayName:'Value', cellFilter: 'currency:"$":3'}
        ]
    };
